 ...
 */
public class Dish1Servlet extends HttpServlet {
    ...
    public void doGet (HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().print(ServletUtils.toJson(dish));
...
//            }
//            response.setContentType("application/json");
//            out.print(ServletUtils.toJson(dishes.get(0)));
//
//
//
