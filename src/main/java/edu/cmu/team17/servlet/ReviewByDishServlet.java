 ...
 */
public class ReviewByDishServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)
            throws IOException {


        int dishId = ServletUtils.getId(request.getRequestURI());
        List<Review> reviews = ReviewDao.listAllByDishId(dishId);
...
//                "and chef.avatarPic = chefImage.id " + "and dishes1.id = " + dishId;
//
//
//
//        try {
